...
/**
 * Load response data into CategorySearchion objects
 *
 * @package IntegerNet\SolrSearch\Result
 */
class CategorySearchionCollection implements IteratorAggregate, Countable
{
    /**
